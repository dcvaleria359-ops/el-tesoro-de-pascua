...
export const zones: ZoneConfig[] = [
  ...
  },
  {
    ...
    mapAspectRatio: 1080 / 1920,
    mapResizeMode: "contain",
    completionVideoUrl: require("../assets/videos/zona3_end.mp4"),
    nextLabel: "IR A LA ZONA 4",
    hotspots: [
      { id: "z3-a", label: "Llama 1", x: 32.1, y: 48.9 },
      { id: "z3-b", label: "Llama 2", x: 37.9, y: 54.5 },
      { id: "z3-c", label: "Llama 3", x: 83.4, y: 65.2 },
      { id: "z3-d", label: "Llama 4", x: 3.1, y: 97.2 },
    ],
  },
  {
    id: 4,
    ...
    accentColor: "#06D6A0",
    mapImage: require("../assets/maps/zona4llama.jpg"),
    mapAspectRatio: 1080 / 1920,
    mapResizeMode: "contain",
    completionVideoUrl: null,
    nextLabel: "VER FINAL",
    hotspots: [
      { id: "z4-a", label: "Llama 1", x: 2.2, y: 79.3 },
      { id: "z4-b", label: "Llama 2", x: 27.9, y: 52.5 },
      { id: "z4-c", label: "Llama 3", x: 41.2, y: 56.1 },
      { id: "z4-d", label: "Llama 4", x: 96.7, y: 56.4 },
      { id: "z4-e", label: "Llama 5", x: 97.4, y: 68.2 },
    ],
  },
];
